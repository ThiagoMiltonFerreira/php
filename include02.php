...
require_once "include01.php"; // so vai incluir uma vez, se por acaso dentro de um includ estiver  chamando o includ01 novamente por exemplo nao vai dar erro pois vai chamar so uma vez e evitar o "loop"
